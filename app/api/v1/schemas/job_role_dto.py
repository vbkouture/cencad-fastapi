...
class JobRoleCreateRequest(BaseModel):
    ...
    description: str = Field(min_length=1, max_length=1000, description="Job role description")


class JobRoleUpdateRequest(BaseModel):
    """Request DTO for updating a job role."""

    name: str | None = Field(None, min_length=1, max_length=200, description="Job role name")
